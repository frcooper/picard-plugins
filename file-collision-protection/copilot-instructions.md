...
Context: This folder contains the `Guardrails — collision-aware renamer` plugin (`guardrails.py`). It detects filename collisions after Picard saves files and either retries naming with a flag or treats the collision as a fatal error.
